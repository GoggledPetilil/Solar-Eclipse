...
#    random_val = rand(6)
    ...
    if pkmn_happiness >= 0 && pkmn_happiness <= 99
      random_val = [1,2].sample
    elsif pkmn_happiness >= 100 && pkmn_happiness <= 199
      random_val = [0,2,3,5].sample
    elsif pkmn_happiness >= 200 && pkmn_happiness <= 255
      random_val = [0,2,3,4,5].sample
    end
